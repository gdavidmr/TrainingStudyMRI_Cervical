...
jobfile = {'G:\projects\03_Scripts\dmri_cervical\training_batch_sc_dwi_mspoas.mat'};
...
for i = 1:length(data)
    ...
    % Get dMRI volumes
    dwi = dir([data{i} filesep 'dmri_cervical' filesep 'derivatives' filesep 'ECMOCO' filesep 'sub-*_ses-*_acq-dmri-cervical_desc-CROP-ECMOCO_dwi.nii']);
